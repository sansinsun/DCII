  ...
  <body id="page-top">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered display responsive  desktop" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php   
                        ...
                        {
                          print "<tr>";
                          print "<td class='col-sm-2'>".$data_detail[$a]['Code']."</td>";
                          ...
                          print '<td><button href="" data-key="'.$a.'" data-code="'.$data_detail[$a]['Code'].'" data-building="'.$data_detail[$a]['Building'].'"
                          data-floor="'.$data_detail[$a]['Floor'].'"  data-room="'.$data_detail[$a]['Room'].'"  data-cubicle="'.$data_detail[$a]['Cubicle'].'"
                          data-type="'.$data_detail[$a]['Type'].'"  data-component="'.$data_detail[$a]['Component'].'"  data-date="'.$data_detail[$a]['Installation Date'].'"
                          data-notes="'.$data_detail[$a]['Notes'].'"
                          type="button" class="form_update btn btn-success btn-xs">Update</button>';
                          print '<button href="" 
                          type="button" id="hapus" data-key="'.$a.'" data-code="'.$data_detail[$a]['Code'].'" class="btn btn-danger btn-xs" style="margin-top:5px;">Delete</button></td>';
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <form action="">
            <div class="form-group row" action="update.php" method="POST">
              <input type="hidden" class="form-control" id="cc"  name="ccode">
              ...
              <div class="col-sm-2">
              <select class="form-control" id="ccb" name="cabinet" placeholder="Cabinet" required>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <select class="form-control" id="ct" name="c_type" required>
              ...
              <div class="col-sm-4">
                <select class="form-control"  id="ce" name="element" required>
                  <option value="" selected disabled></option>
            ...
            <div class="form-group row">
              <label for="date" class="col-sm-2 col-form-label"  name="cdate" value="<?php echo $date;?>" required>Installation Date</label>
              <div class="col-sm-4">
                <input type="date" class="form-control" id="cd" name="date">
              </div>
            </div>
            <div class="form-group row">
              <label for="notes" class="col-sm-2 col-form-label">Notes</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="cn" name="notes">
              </div>
            </div>
            <button type="submit" data-toggle="modal" data-target="#success" class="btn btn-primary btn-md"  style="float:right; margin-right:0px; width:150px;">Save</a>
    ...
    $(document).ready(function(){
       $(".form_update").click(function(){ 
            ...
            $("#code").val(ccode);
            $("#gedung").val(cbuilding);
            $('#lantai option:contains(' + cfloor + ')').prop({selected: true});
            $('#room option:contains(' + croom + ')').prop({selected: true});
